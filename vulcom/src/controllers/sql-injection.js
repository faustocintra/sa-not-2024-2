...
controller.processLoginSqlInjection = async function (req, res) {
    try {
        ...
        // Para produzir uma injeção de SQL que apaga a tabela 'users', 
        // basta informar a string abaixo no campo 'username': 
...
controller.processLogin = async function (req, res) {
    try {
        ...
        // Para evitar SQL Injection, os valores de 'username' e 'password'
        // serão passados à conexão com o banco de dados como parâmetros
        ...
        // Consulta é feita mesclando o texto do SQL com os parâmetros, de
        // forma segura
